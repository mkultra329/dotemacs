...
(setq-default
 ...
 cursor-type 'bar                                 ; Use a bar-shaped cursor
...
;;     (set-face-attribute 'avy-lead-face nil :italic nil))
...
;;     (set-face-attribute 'org-quote nil :inherit 'font-lock-doc-face))
...
(use-package doom-themes
  ...
  (doom-themes-set-faces nil
    ...
    '(font-lock-comment-face :foreground base7)
    '(font-lock-comment-delimiter-face :foreground fg-alt)
    '(font-lock-doc-face :foreground fg-alt :italic t)
    '(help-argument-name :foreground variables)
    '(helpful-heading :height me/font-size-large :foreground orange)
    '(hl-line :background base2)
    '(isearch :background cyan :foreground dark-cyan)
    '(ivy-current-match :background base2)
    '(ivy-virtual :foreground fg-alt :italic nil)
    '(lazy-highlight :background dark-cyan :foreground cyan)
    '(magit-diff-added :background 'unspecified)
    '(magit-diff-hunk-region :inherit 'region)
    '(magit-diff-removed :background 'unspecified)
    '(magit-section-heading :height me/font-size-large :foreground orange)
    '(mode-line-inactive :background base3)
    '(org-block-begin-line :background 'unspecified :foreground 'unspecified :inherit font-lock-comment-face)
...
")
  ...
  ("f" (lambda () (interactive) (flycheck-next-error 1 t)))
  ("F" flycheck-buffer)
...
")
  ...
  ("w" (lambda () (interactive) (revert-buffer nil t)) :color blue)
