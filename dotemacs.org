...
(fringe-mode '(1 . 0))                            ; Initialize thinner vertical fringes
...
(defhydra hydra-system (:color blue)
 ...
 ^^                    _r_ refresh           _T_ ansi-term         _s_ list processes
")
  ("q" nil)
...
(defhydra hydra-ui (:color red)
  (concat "\n " (me/hydra-heading "User Interface" "Frame" "Zoom" "Line Numbers")
          "
 _q_ quit              _m_ maximize          _-_ out               _l_ mode: %s`display-line-numbers
 ^^                    ^^                    _=_ in                _L_ absolute: %s`display-line-numbers-current-absolute
 ^^                    ^^                    _0_ reset             ^^
")
  ("q" nil)
  ("l" me/display-line-numbers-toggle-type)
  ("L" me/display-line-numbers-toggle-absolute)
...
(setq-default
 ...
 display-line-numbers-type 'visual                ; Prefer relative numbers
